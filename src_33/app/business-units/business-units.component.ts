...
businessUnitInfo=[];
businessUnitKeyValue;
getBusinessUnitInfo(){
  this.BusinessGroupCrudService.getBusinessGroupDetails().subscribe(product => {
    this.businessUnitInfo =product.json().businessGroups;
    console.log("Business Unit information"+JSON.stringify(this.businessGroupInfo));
...
this.businessUnitKeyValue[this.businessGroupInfo[i].name]=this.businessGroupInfo[i].businessGroupId;
