...
public height: Number=180;
  ...
  dtTrigger: Subject<any> = new Subject();
    ...
    searchsuggestions=['Manage Client','Manage Business unit','Manage Business Group','Manage Subscriber','Manage Groups','Manage Providers','Manage Credentials','Manage Resource types','Manage Services'];
searchResult=['Manage Client','Manage Business unit','Manage Business Group','Manage Subscriber','Manage Groups','Manage Providers','Manage Credentials','Manage Resource types','Manage Services'];
