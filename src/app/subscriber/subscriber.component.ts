...
SubscriberNameUpdateValidation():boolean{
  if(!this.IncidentEditable){
       if(this.subscriberName==''){
         this.subscriberNameUpdateErrorMessage="Client Name Cant be empty"
         return true;
       }
       else if(!(/^[a-zA-Z\s]+$/.test(this.subscriberName))){
        this.subscriberNameUpdateErrorMessage="Client Name Cant have numbers or any spectialcharecters"
        return true;
       }
       else if(this.subscriberName.length<3){
        this.subscriberNameUpdateErrorMessage="Client Name Cant be less than 3 charecters"
        return true;
       }
       else if(this.subscriberName.length>40){
        this.subscriberNameUpdateErrorMessage="Client Name Cant be greater than 40 charecters"
        return true;
