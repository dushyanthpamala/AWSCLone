...
defaultUpdateValues(){
  this.clientNameupdate=this.DetailSelected.clientName;
  this.shortNameupdate=this.DetailSelected.shortName;
  this.addressupdate=this.DetailSelected.address;
  this.remarksupdate=this.DetailSelected.remarks;
  this.statusupdate=this.DetailSelected.status;
  ...
  this.clientCounter=product.json().clients.length;
  console.log("Total Records---->"+this.clientCounter);
            ...
            if(i==0){
              ...
              this.testvalue=this.DetailSelected.clientId;
              this.defaultUpdateValues();
               this.DataToCsv=product.json().clients[i];
...
ClientUpdateValidation():boolean{
  if(!this.IncidentEditable){
       if(this.clientNameupdate==''){
         this.clientUpdateErrorMessage="Client Name Cant be empty"
         return true;
       }
       else if(!(/^[a-zA-Z\s]+$/.test(this.clientNameupdate))){
        this.clientUpdateErrorMessage="Please enter valid Client Name"
        return true;
       }
       else if(this.clientNameupdate.length<3){
        this.clientUpdateErrorMessage="Minimum 3 charecters required"
        return true;
       }
       else if(this.clientNameupdate.length>40){
...
shortNameUpdateValidation(){
  if(!this.IncidentEditable){
    if(this.shortNameupdate==''){
      this.shortNameUpdateErrorMessage="Short Name Cant be empty"
      return true;
    }
    else if(!(/^[a-zA-Z]+$/.test(this.shortNameupdate))){
     this.shortNameUpdateErrorMessage="Please enter valid Short Name"
     return true;
    }
    else if(this.shortNameupdate.length<3){
     this.shortNameUpdateErrorMessage="Minimum 3 charecters required"
     return true;
    }
    else if(this.shortNameupdate.length>40){
...
addressupdateValidation(){
  if(!this.IncidentEditable){
    ...
    else if(!(/^[a-zA-Z0-9\s\\\#\-\.\,\/]+$/.test(this.addressupdate))){
     this.addressupdateErrorMessage="Please enter valid Address"
     return true;
    }
    else if(this.addressupdate.length<3){
     this.addressupdateErrorMessage="Minimum 3 charecters required"
     return true;
    }
...
remarksupdateValidation(){
  if(!this.IncidentEditable){
    if(this.remarksupdate==''){
     ...
     this.remarksupdateErrorMessage="Please enter valid Remarks without Spectialcharecters"
     return true;
    }
    else if(this.remarksupdate.length<3){
     this.remarksupdateErrorMessage="Minimum 3 charecters required"
     return true;
    }
...
phoneupdateValidation(){
  if(!this.IncidentEditable){
    if(this.phoneupdate==''){
     ...
     this.phoneupdateErrorMessage="Please enter valid Phone number"
     return true;
    }
