...
$('.dataTables_wrapper .dataTables_paginate .paginate_button.current, .dataTables_wrapper .dataTables_paginate .paginate_button.current:hover').css({
  color: 'red !important', margin: '3px',
...
let temppostvalues=values;
  ...
  MakeAddClientEnable(){
    ...
    this.SharedService.OptionSelectedtest.next('ADD NEW BUSINESSUNIT');
...
BusinessUnitNameUpdateValidation():boolean{
  if(!this.IncidentEditable){
       if(this.BusinessUnitNameUpdate==''){
         this.BusinessUnitNameUpdateErrorMessage="Business Unit Name Cant be empty"
         return true;
       }
       else if(!(/^[a-zA-Z\s]+$/.test(this.BusinessUnitNameUpdate))){
        this.BusinessUnitNameUpdateErrorMessage="Business Unit Name Cant have numbers or any spectialcharecters"
        return true;
       }
       else if(this.BusinessUnitNameUpdate.length<3){
        this.BusinessUnitNameUpdateErrorMessage="Business Unit Name Cant be less than 3 charecters"
        return true;
       }
       else if(this.BusinessUnitNameUpdate.length>40){
        this.BusinessUnitNameUpdateErrorMessage="Business Unit Name Cant be greater than 40 charecters"
        return true;
...
shortNameUpdateValidation(){
  if(!this.IncidentEditable){
    if(this.BusinessShortNameupdate==''){
      this.shortNameUpdateErrorMessage="Business Unit Short Name Cant be empty"
      return true;
    }
    else if(!(/^[a-zA-Z]+$/.test(this.BusinessShortNameupdate))){
     this.shortNameUpdateErrorMessage="Business Unit Short Name Cant have numbers or any spectialcharecters"
     return true;
    }
    else if(this.BusinessShortNameupdate.length<3){
     this.shortNameUpdateErrorMessage="Business Unit Short Name Cant be less than 3 charecters"
     return true;
    }
    else if(this.BusinessShortNameupdate.length>40){
     this.shortNameUpdateErrorMessage="Business Unit Short Name Cant be greater than 40 charecters"
     return true;
